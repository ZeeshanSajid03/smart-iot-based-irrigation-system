...
import {
    FaThLarge, FaWifi, FaHistory, FaCloudSun,
    FaLeaf, FaCog, FaUser, FaSignOutAlt, FaBars, FaTimes
} from 'react-icons/fa';
...
const DashboardLayout = () => {
    ...
    const SidebarContent = () => (
        <>
            {/* Logo + close button row (close only shows on mobile) */}
            <div className="d-flex align-items-center justify-content-between mb-5 mt-2">
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div className="text-white-50 extra-small">IoT Control System</div>
                    </div>
                </div>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
                ...
                <header className="dashboard-header px-3 px-md-4">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0, flex: 1 }}>
                        ...
                        {/* Short date for very small screens */}
                        <span className="header-time-text d-sm-none">
                            {currentDate.toLocaleTimeString()}
                        </span>
                    </div>

                    {/* Right: weather + bell + user + logout */}
